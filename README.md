...
collection loader/saver (`CollectionStore`) — 85 tests green. The Avalonia app has a menu
...
client/server code in a Code tab. Settings (theme, font) persist; the window shows its
tag-derived version.
